<section class="paginacion">
	<ul>
		...
		<?php else: ?>
			<li><a href="consulta.php?p=<?php echo pagina_actual() - 1?>">&laquo;</a></li>
		<?php endif; ?>
		...
		<?php for ($i = 1; $i <= $numero_paginas; $i++): ?>
			...
			<?php else: ?>
				<li>
					<a href="consulta.php?p=<?php echo $i?>"><?php echo $i; ?></a>
				</li>
			<?php endif; ?>
		<?php endfor; ?>
		...
		<?php else: ?>
			<li><a href="consulta.php?p=<?php echo pagina_actual() + 1; ?>">&raquo;</a></li>
		<?php endif; ?>
	</ul>
</section>