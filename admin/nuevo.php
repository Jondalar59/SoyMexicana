...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$semestre = limpiarDatos($_POST['semestre']);
	$grupo = limpiarDatos($_POST['grupo']);
	$turno = limpiarDatos($_POST['turno']);
	$aula = limpiarDatos($_POST['aula']);
	...
	$statement = $conexion->prepare(
		...
		VALUES (null, :nombre, :correo, :estudiante, :telefono, :n_control, :carrera, :semestre, :grupo, :turno, :aula, :queja, :sugerencia, "En Espera", "Sin Respuesta por el Momento")'
	);
