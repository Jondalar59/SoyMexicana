...
function obtener_post_por_id($conexion, $id){
	$resultado = $conexion->query("SELECT * FROM formulario WHERE id = $id LIMIT 1");
...
function obtener_post($post_por_pagina, $conexion){
	...
	$sentencia = $conexion->prepare("SELECT SQL_CALC_FOUND_ROWS * FROM formulario LIMIT {$inicio}, {$post_por_pagina}");
